...
def show_or_hide_upsampling_elements(project_name, sample_id, upsampling_running):
  ...
  available_level_names = lib.ui.components.upsampling.UPSAMPLING_LEVEL_NAMES[:len(levels)]
  ...
  return {
    ...
    lib.ui.components.upsampling.upsampling_status: gr.update(
      visible = upsampling_running,
    ),
    lib.ui.components.upsampling.upsampling_level: gr.update(
