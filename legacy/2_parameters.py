if True:
  ...
  # If settings.json exists in the project folder, load it with artist, genre and lyrics data
  if os.path.exists(f'{hps.name}/settings.json'):
    with open(f'{hps.name}/settings.json', 'r') as f:
